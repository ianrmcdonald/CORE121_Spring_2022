...
**Step 1: Log into the RStudio server from <https://rstudio.cloud/>. Follow the links until you see the RStudio display that looks like this:**

![RStudio Screen Capture](img/fig_1.png){width=75%}
...
![RStudio Screen Capture](img/fig_2.png){width=50%}

Click on "New Directory" then "New Project."  Enter "Lab 1" as your directory name. Leave the two boxes unchecked.
...
![RStudio Screen Capture](img/fig_3.png){width=75%}
